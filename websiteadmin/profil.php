                ...
                <div class="con2">
                    <div class="bar1">
                        <div class="bio">
                            ...
                            <div class="icon">
                                <img src="icon/facebook.ico" style="width:35px;" alt="">
                                <img src="icon/images.png" style="width:33px;" alt="">
                                <img src="icon/instagram.ico" style="width: 33px;px;" alt="">
                                <img src="icon/github-logo.ico" style="width:33px;" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="bar2">
